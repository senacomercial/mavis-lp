    ...
    <section id="top" style={{
      ...
      <div style={{maxWidth:1100, margin:'0 auto', width:'100%'}}>
        ...
        <div style={{display:'flex',gap:14,flexWrap:'wrap'}}>
          <CTAButton size="lg" icon={<span>📲</span>}>Agende uma Análise da Operação</CTAButton>
          <CTAButton size="lg" variant="ghost">Ver o método MaVIS</CTAButton>
        </div>
        <div style={{
          display:'flex', gap:40, marginTop:64, paddingTop:28,
          borderTop:'1px solid rgba(255,255,255,.1)', flexWrap:'wrap'
        }}>
