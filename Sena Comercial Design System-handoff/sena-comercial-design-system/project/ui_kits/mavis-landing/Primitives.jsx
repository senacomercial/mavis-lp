...
function CTAButton({ variant = 'primary', children, onClick, icon, size = 'md' }) {
...
function Overline({ children, variant = 'gold' }) {
  return <span style={{
...
function Highlight({ children, color='orange' }) {
  return <em style={{
...
function SectionHeader({ over, title, lede, align='left' }) {
  return (
...
Object.assign(window, { CTAButton, Overline, Highlight, SectionHeader });
