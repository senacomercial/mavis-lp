      ...
      <section id="method" style={{padding:'120px 32px', background:'linear-gradient(180deg,#000,#0A0A0A)'}}>
        <div style={{maxWidth:1100, margin:'0 auto'}}>
          ...
          <div style={{maxWidth:720, margin:'56px auto 0'}}>
            <FilterBlock title="O Protocolo MaVIS" steps={steps}/>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" style={{padding:'120px 32px', background:'#0A0A0A'}}>
        <div style={{maxWidth:1100, margin:'0 auto'}}>
          ...
          <div style={{marginTop:56, display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:18}}>
            <PricingCard over="Grupo · 6 meses" name="Mentoria em Grupo" price="R$ 6.500" pricePromo="R$ 4.950"
            ...
            <PricingCard over="Estruturação Estratégica · intensivo" name="Estruturação Estratégica Diagnóstica" price="R$ 20.000" pricePromo="R$ 18.000" featured
            ...
            <PricingCard over="Implantação + individual" name="Implantação Completa" price="R$ 30.000" pricePromo="R$ 27.000"
      ...
      <section id="cta" style={{
        ...
        <div style={{maxWidth:820, margin:'0 auto'}}>
          ...
          <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap'}}>
            <CTAButton size="lg" icon={<span>📲</span>}>Entrar no Grupo VIP</CTAButton>
